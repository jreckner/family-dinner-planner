    ...
    return (
        <div className="pb-1">
            <div className="relative">
                <input type="text"
                    value={query}
                    onChange={(event) => handleSearchRecipe(event.target.value)}
                    placeholder="Search..."
                ...
                <RiDeleteBin2Line className="fill-red-700 cursor-pointer absolute right-3 top-1/2 -translate-y-1/2 text-gray-500" size='1.3em' onClick={() => handleClearSearch()} />
            </div>
        </div>
    );
}
